...
<!-- BEGIN HOST-PLATFORM (generated - do not hand-edit) -->
...
Canonical source: `C:\AI\orchestrator\docs\PLATFORM.md`. To change it, run
`powershell -File C:\AI\orchestrator\scripts\set-platform.ps1 -Platform <windows|mac|linux>` - once.
<!-- END HOST-PLATFORM -->
